...
class scene():
    ...
    def __init__(self,
        ...
        if (self.Ntime == 1):
            self.xystar = self.xystar[np.newaxis, :]
        ...
        if (self.Ntime == 1):
            self.bposstar = self.bposstar[np.newaxis, :]
        ...
        if (self.Ntime == 1):
            self.bvelstar = self.bvelstar[np.newaxis, :]
        ...
        if (self.Ntime == 1):
            self.fstar = self.fstar[np.newaxis, :]
        ...
        for i in range(self.Nplanets):
            ...
            if (self.Ntime == 1):
                self.fplanet[i] = fplanet_interp(self.wave, self.time)[np.newaxis, :] # Jy
            else:
